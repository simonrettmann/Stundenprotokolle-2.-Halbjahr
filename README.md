...
Es stellte sich heraus, dass die aus dem Internet kopierten Scripts leider sehr fehlerhaft waren, sodass Fehler an mehreren Stellen auftauchten, die behoben werden mussten. Selbst das Aufrufen der Website, die im Video gezeigt war, funktionierte nicht. Dieser Fehler konnte jedoch schnell behoben werden, da das Hauptdokument, dass die Website in html vorgibt "index.php" und nicht "main.php" heißen muss. Anschließend konnte die Website aufgerufen werden.
...
//const char *host = "phpmyadmin.atw.io";
